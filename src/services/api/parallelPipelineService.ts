...
async function uploadToFirebaseInBackground(
  ...
  try {
    ...
    const { uploadAudioFromUrlWithRetry } = await import('../firebase/streamingFirebaseUpload');
...
async function uploadBlobToFirebaseInBackground(
  ...
  try {
    ...
    const { uploadAudioBlobWithRetry } = await import('../firebase/streamingFirebaseUpload');
